...
(function () {
  ...
  WebpackageConverter.prototype._determineTransformationList = function (sourceModelVersion) {
    ...
    var key = Object.keys(this._transformationMatrix).find(function (elem) {
      return sourceModelVersion.startsWith(elem);
    });
   ...
   * @private
   * @param {function} callback callback function. It will be called, after handled all files.
   */
  WebpackageConverter.prototype._changeRTEVersionInHTMLFiles = function (callback) {
    var self = this;
    // Use promises and callback for unittest
    var promises = [];
    filterFiles(this._webpackagePath, /\.html$/, function (filename) {
      var promise = new Promise(function (resolve, reject) {
        fs.readFile(filename, 'utf8', function (err, data) {
          ...
          var pattern = /(cubx.core.rte@)(\d{1,3}\.\d{1,3}\.\d{1,3})(\/)/g;
          var newData = data.replace(pattern, '$1' + self._rteTargetVersion + '$3');
   ...
   * @param {function} callback callback function. It will be called, after handled all files.
   */
  WebpackageConverter.prototype._changeWebcomponentsPathInHTMLFiles = function (callback) {
    var promises = [];
    filterFiles(this._webpackagePath, /\.html$/, function (filename) {
      var promise = new Promise(function (resolve, reject) {
        fs.readFile(filename, 'utf8', function (err, data) {
          ...
          if (artifact.hasOwnProperty('dependencies')) {
            artifact.dependencies.forEach(function (dep) {
              if (dep.webpackageId && dep.webpackageId.startsWith('cubx.core.rte')) {
                dep.webpackageId = dep.webpackageId.replace(/(cubx.core.rte@)(\d{1,3}\.\d{1,3}\.\d{1,3})/, '$1' + self._rteTargetVersion);
